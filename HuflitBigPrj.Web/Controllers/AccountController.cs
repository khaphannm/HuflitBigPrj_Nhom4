...
using HuflitBigPrj.Sessions;
using HuflitBigPrj.Web.Controllers.Results;
using HuflitBigPrj.Web.Models;
using HuflitBigPrj.Web.Models.Account;
using Microsoft.AspNet.Identity;
using Microsoft.AspNet.Identity.Owin;
using Microsoft.Owin.Security;

namespace HuflitBigPrj.Web.Controllers
{
    public class AccountController : HuflitBigPrjControllerBase
    {
